...
const PACKAGE_ID = '2026-08-25-32EDDB85';
...
export default function Homework20260825({ onOpenHomework2, onOpenHomework1, darkMode, toggleDarkMode }) {
    ...
    <div className="min-h-screen bg-stone-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100">
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur border-b border-stone-200 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div className="flex items-center gap-3"><div className="p-2 rounded-xl bg-slate-900 dark:bg-blue-600 text-white"><BookOpen className="w-5 h-5"/></div><div><div className="font-extrabold">Eugenia's Homework Workspace</div><div className="text-xs text-stone-500 dark:text-slate-400">Homework 3 · {data.dateLabel}</div></div></div>
          <div className="flex gap-2 items-center flex-wrap">
            <button className="px-4 py-2 rounded-xl bg-blue-600 text-white text-sm font-bold">Homework 3 <span className="ml-1 text-[10px] uppercase bg-white/20 px-2 py-1 rounded-full">Latest</span></button>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 pb-20">
        <div className="rounded-3xl p-8 md:p-10 mb-8 bg-gradient-to-br from-blue-50 to-violet-50 dark:from-blue-950/40 dark:to-violet-950/30 border border-blue-100 dark:border-blue-900">
          <div className="flex flex-col md:flex-row gap-8 md:items-end justify-between">
            <div><div className="text-xs font-black uppercase tracking-widest text-blue-700 dark:text-blue-300 mb-3">More challenging revision</div><h1 className="text-4xl md:text-5xl font-extrabold font-serif mb-4">{data.title}</h1><p className="text-lg text-stone-600 dark:text-slate-300 max-w-3xl">{data.subtitle}</p></div>
